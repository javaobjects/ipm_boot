!
    ...
    function() {
        ...
        jsPlumbUtil = {
            ...
            indexOf: function(a, b) {
                return a.indexOf ? a.indexOf(b) : jsPlumbUtil.findWithFunction(a,
                    function(a) {
                        return a == b
                    })
            },
            ...
            addWithFunction: function(a, b, c) { - 1 == jsPlumbUtil.findWithFunction(a, c) && a.push(b)
            },
    ...
    function() {
        var a = !!window.SVGAngle || document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1"),
            b = function() {
                if (void 0 === b.vml) {
                    ...
                    var c = a.firstChild;
                    null != c && null != c.style ? (c.style.behavior = "url(#default#VML)", b.vml = c ? "object" == typeof c.adj: !0) : b.vml = !1,
            ...
            k = function(a) {
                ...
                this.register = function(g) {
                    ...
                    this.endpointAdded = function(c) {
                        var g = document.body,
                            h = a.getId(c),
                            i = jsPlumbAdapter.getOffset(c, a),
                            j = c.parentNode;
                    ...
                    this.setParent = function(b, c, e, g) {
                        ...
                        if (h) {
                            d[g] || (d[g] = {}),
                                d[g][c] = d[h][c],
                                delete d[h][c];
                            var i = jsPlumbAdapter.getOffset(e, a),
                                j = jsPlumbAdapter.getOffset(b, a);
                            d[g][c].offset = {
                                left: j.left - i.left,
                                top: j.top - i.top
                            },
        ...
        var l = function(a) {
            ...
            o = function(a, b, c) {
                for (var d = c.split(/\s+/), e = n(a), f = e.split(/\s+/), g = 0; g < d.length; g++) if (b) - 1 == jsPlumbUtil.indexOf(f, d[g]) && f.push(d[g]);
                else {
                    var h = jsPlumbUtil.indexOf(f, d[g]); - 1 != h && f.splice(h, 1)
                }
                m(a, f.join(" "))
            },
            p = function(a, b) {
                if (null != a) if ("string" == typeof a) b(jsPlumb.getDOMElement(a));
                else if (null != a.length) for (var c = 0; c < a.length; c++) b(jsPlumb.getDOMElement(a[c]));
                else b(a)
            };
        window.jsPlumbAdapter = {
            ...
            hasClass: function(a, b) {
                return a = jsPlumb.getDOMElement(a),
                    a.classList ? a.classList.contains(b) : -1 != n(a).indexOf(b)
            },
            ...
            getOffset: function(a, b, c) {
                ...
                for (var d = b.getContainer(), e = a.offsetLeft, f = a.offsetTop, g = c || null != d && a.offsetParent != d ? a.offsetParent: null; null != g;) e += g.offsetLeft,
                    f += g.offsetTop,
            ...
            getPositionOnElement: function(a, b, c) {
                var d = "undefined" != typeof b.getBoundingClientRect ? b.getBoundingClientRect() : {
                    ...
                    m = d.top + g - i + k * c,
                    n = d.left + h - j + l * c,
                    o = jsPlumbAdapter.pageLocation(a),
    ...
    function() {
        ...
        var a = jsPlumbUtil,
            ...
            d = function(a) {
                if (a._jsPlumb.paintStyle && a._jsPlumb.hoverPaintStyle) {
                    var b = {};
                    t.extend(b, a._jsPlumb.paintStyle),
                        t.extend(b, a._jsPlumb.hoverPaintStyle),
            ...
            j = window.jsPlumbUIComponent = function(b) {
                ...
                var j = [],
                    ...
                    m = function(a, b, c, d) {
                        ...
                        l.push([a, c, g, b]),
                            b._jsPlumb.instance.on(a, c, g)
                    },
                    n = function(a, b, c, d) {
                        f[b] || b,
                            d._jsPlumb.instance.off(a, b, c)
                    };
                this.bindListeners = function(a, b, c) {
                    ...
                    this.attachListeners = function(a, b, c) {
                        c = c || {};
                        for (var d = 0,
                                 f = e.length; f > d; d++) m(a, b, e[d], c[e[d]])
                    },
                ...
                if (a.isArray(c)) {
                    var e = c[0],
                        f = t.extend({
                            ...
                            c[1]);
                    3 == c.length && t.extend(f, c[2]),
                        d = new(t.Overlays[b._jsPlumb.instance.getRenderMode()][e])(f)
        ...
        jsPlumbUtil.extend(p, j, {
            ...
            moveParent: function(a) {
                this.bgCanvas && (this.bgCanvas.parentNode.removeChild(this.bgCanvas), a.appendChild(this.bgCanvas)),
            ...
            s = window.jsPlumbInstance = function(d) {
                ...
                this.getInstanceIndex = function() {
                    ...
                    this.setZoom = function(a, b) {
                        return jsPlumbUtil.oldIE || (i = a, e.fire("zoom", i), b && e.repaintEverything()),
                            !jsPlumbUtil.oldIE
                    },
                ...
                this.setContainer = function(a) {
                    ...
                    e.importDefaults = function(a) {
                        ...
                        return a.Container && this.setContainer(a.Container),
                            e
                    },
                    e.restoreDefaults = function() {
                        return e.Defaults = t.extend({},
                            h),
                            e
                    };
                var n = null,
                    ...
                    I = function(a, b, d, f) {
                        if (!jsPlumbAdapter.headless && !A) {
                            var g = Y(a),
                                h = e.dragManager.getElementsForDraggable(g);
                            null == d && (d = c());
                            var i = W({
                                elId: g,
                                offset: b,
                    ...
                    J = function(b, c) {
                        ...
                        if (a.isArray(b)) {
                            h = [];
                            for (var i = 0,
                                     j = b.length; j > i; i++) d = e.getElementObject(b[i]),
                                g = e.getDOMElement(d),
                                f = e.getAttribute(g, "id"),
                                h.push(c.apply(e, [g, f]))
                        } else d = e.getDOMElement(b),
                            f = e.getId(d),
                            h = c.apply(e, [d, f]);
                        return h
                    },
                    ...
                    L = function(b, c, d) {
                        if (!jsPlumbAdapter.headless) {
                            ...
                            if (f && t.isDragSupported(b, e) && !t.isAlreadyDraggable(b, e)) {
                                ...
                                g = t.extend({},
                                    g);
                                var h = t.dragEvents.drag,
                                    i = t.dragEvents.stop,
                                    j = t.dragEvents.start;
                                g[j] = a.wrap(g[j],
                                    function() {
                                        return e.setHoverSuspended(!0),
                                            e.select({
                                                source: b
                                            }).addClass(e.elementDraggingClass + " " + e.sourceElementDraggingClass, !0),
                                            e.select({
                                                target: b
                                            }).addClass(e.elementDraggingClass + " " + e.targetElementDraggingClass, !0),
                                            e.setConnectionBeingDragged(!0),
                                            g.canDrag ? d.canDrag() : void 0
                                    },
                                    !1),
                                    g[h] = a.wrap(g[h],
                                        function() {
                                            var a = e.getUIPosition(arguments, e.getZoom());
                                            I(b, a, null, !0),
                                                e.addClass(b, "jsPlumb_dragged")
                                        }),
                                    g[i] = a.wrap(g[i],
                                        function() {
                                            var a = e.getUIPosition(arguments, e.getZoom(), !0);
                                            I(b, a),
                                                e.removeClass(b, "jsPlumb_dragged"),
                                                e.setHoverSuspended(!1),
                                                e.select({
                                                    source: b
                                                }).removeClass(e.elementDraggingClass + " " + e.sourceElementDraggingClass, !0),
                                                e.select({
                                                    target: b
                                                }).removeClass(e.elementDraggingClass + " " + e.targetElementDraggingClass, !0),
                                ...
                                x[k] = !0;
                                var l = x[k];
                                g.disabled = null == l ? !1 : !l,
                                    e.initDraggable(b, g, !1),
                                    e.dragManager.register(b)
                            }
                        }
                    },
                    M = function(b, c) {
                        ...
                        if (d.target && !d.target.endpoint && !d.targetEndpoint && !d.newConnection && (h = Y(d.target), i = this.targetEndpointDefinitions[h])) {
                            if (!i.enabled) return;
                            i.isTarget = !0,
                                j = null != i.endpoint && i.endpoint._jsPlumb ? i.endpoint: e.addEndpoint(d.target, i.def),
                            i.uniqueEndpoint && (i.endpoint = j),
                                d.targetEndpoint = j,
                                j._doNotDeleteOnDetach = !1,
                                j._deleteOnDetach = !0
                        }
                        if (d.source && !d.source.endpoint && !d.sourceEndpoint && !d.newConnection && (h = Y(d.source), i = this.sourceEndpointDefinitions[h])) {
                            if (!i.enabled) return;
                            j = null != i.endpoint && i.endpoint._jsPlumb ? i.endpoint: e.addEndpoint(d.source, i.def),
                            i.uniqueEndpoint && (i.endpoint = j),
                                d.sourceEndpoint = j,
                                j._doNotDeleteOnDetach = !1,
                                j._deleteOnDetach = !0
                    ...
                    N = function(a) {
                        ...
                        e.Defaults.EndpointType || t.Endpoint,
                            a._jsPlumb = e,
                            a.newConnection = N,
                            a.newEndpoint = Q,
                            a.endpointsByUUID = s,
                            a.endpointsByElement = q,
                            a.finaliseConnection = O;
                        var c = new b(a);
                        return c.id = "con_" + F(),
                            P("click", "click", c),
                            P("dblclick", "dblclick", c),
                            P("contextmenu", "contextmenu", c),
                        c.isDetachable() && (c.endpoints[0].initDraggable(), c.endpoints[1].initDraggable()),
                            c
                    },
                    O = function(a, b, c, d) {
                        if (b = b || {},
                            a.suspendedEndpoint || p.push(a), (null == a.suspendedEndpoint || d) && e.anchorManager.newConnection(a), I(a.source), !b.doNotFireConnectionEvent && b.fireEvent !== !1) {
                            var f = {
                                connection: a,
                                source: a.source,
                                target: a.target,
                    ...
                    Q = function(a) {
                        var b = e.Defaults.EndpointType || t.Endpoint,
                            c = t.extend({},
                                a);
                        c._jsPlumb = e,
                            c.newConnection = N,
                            c.newEndpoint = Q,
                            c.endpointsByUUID = s,
                            c.endpointsByElement = q,
                            c.finaliseConnection = O,
                            c.fireDetachEvent = _,
                            c.fireMoveEvent = ab,
                            c.floatingConnections = w,
                            c.elementId = Y(c.source);
                        var d = new b(c);
                        return d.id = "ep_" + F(),
                            P("click", "endpointClick", d),
                            P("dblclick", "endpointDblClick", d),
                            P("contextmenu", "contextmenu", d),
                        jsPlumbAdapter.headless || e.dragManager.endpointAdded(c.source),
                            d
                    },
                    R = function(a, b, c) {
                        var d = q[a];
                    ...
                    S = function(a, b) {
                        return J(a,
                            function(a, c) {
                                x[c] = b,
                                this.isDragSupported(a) && this.setElementDraggable(a, b)
                            })
                    },
                    T = function(a, b, c) {
                        b = "block" === b;
                    ...
                    Y = function(a, b, c) {
                        ...
                        return d && "undefined" !== d || (2 == arguments.length && void 0 !== arguments[1] ? d = b: (1 == arguments.length || 3 == arguments.length && !arguments[2]) && (d = "jsPlumb_" + f + "_" + F()), c || e.setAttribute(a, "id", d)),
                            d
                    };
                this.setConnectionBeingDragged = function(a) {
                    ...
                    this.addEndpoint = function(b, c, d) {
                        ...
                        for (var g = [], h = a.isArray(b) || null != b.length && !a.isString(b) ? b: [b], i = 0, j = h.length; j > i; i++) {
                            ...
                            var m = Q(f);
                            f.parentAnchor && (m.parentAnchor = f.parentAnchor),
                                a.addToList(q, l, m);
                            var n = u[l],
                                o = z[l],
                                p = m.anchor.compute({
                    ...
                    this.animate = function(b, c, d) {
                        d = d || {};
                        var f = this.getElementObject(b),
                            g = this.getDOMElement(b),
                            h = Y(g),
                            i = t.animEvents.step,
                    ...
                    this.checkCondition = function(b, c) {
                        var d = e.getListener(b),
                            f = !0;
                        if (d && d.length > 0) try {
                            for (var g = 0,
                                     h = d.length; h > g; g++) f = f && d[g](c)
                        } catch(i) {
                    ...
                    this.connect = function(a, b) {
                        var c, d = M(a, b);
                        return d && (qb(d.source), c = N(d), O(c, d)),
                            c
                    };
                var Z = [{
                        el: "source",
                    ...
                    $ = function(a, b, c, d) {
                        ...
                        if (b.constructor == t.Endpoint) e = b,
                            e.addConnection(a);
                            ...
                            e._doNotDeleteOnDetach = !1,
                            e._deleteOnDetach = !0;
                        return null != e && (j.detachFromConnection(a), a.endpoints[c] = e, a[h.el] = e.element, a[h.elId] = e.elementId, k[0 === c ? "newSourceId": "newTargetId"] = e.elementId, ab(k), d || a.repaint()),
                            k
                    }.bind(this);
                this.setSource = function(a, b, c) {
                    ...
                    this.deleteEndpoint = function(a, b) {
                        var c = e.setSuspendDrawing(!0),
                            d = "string" == typeof a ? s[a] : a;
                        return d && e.deleteObject({
                            endpoint: d
                        }),
                        c || e.setSuspendDrawing(!1, b),
                            e
                    },
                    this.deleteEveryEndpoint = function() {
                        ...
                        for (var b in q) {
                            ...
                            if (c && c.length) for (var d = 0,
                                                        f = c.length; f > d; d++) e.deleteEndpoint(c[d], !0)
                        }
                        return q = {},
                            s = {},
                            e.anchorManager.reset(),
                            e.dragManager.reset(),
                        a || e.setSuspendDrawing(!1),
                            e
                    };
                var _ = function(a, b, c) {
                        ...
                        b && e.fire("connectionDetached", g, c),
                            e.anchorManager.connectionDetached(g)
                    },
                    ab = function(a, b) {
                        e.fire("connectionMoved", a, b)
                    };
                this.unregisterEndpoint = function(a) {
                    a._jsPlumb.uuid && (s[a._jsPlumb.uuid] = null),
                        e.anchorManager.deleteEndpoint(a);
                    for (var b in q) {
                        var c = q[b];
                        if (c) {
                    ...
                    this.detach = function() {
                        if (0 !== arguments.length) {
                            ...
                            if (g)(f || jsPlumbUtil.functionChain(!0, !1, [[g.endpoints[0], "isDetachAllowed", [g]], [g.endpoints[1], "isDetachAllowed", [g]], [g, "isDetachAllowed", [g]], [e, "checkCondition", ["beforeDetach", g]]])) && g.endpoints[0].detach(g, !1, !0, d);
                            else {
                                var h = t.extend({},
                                    c);
                                if (h.uuids) K(h.uuids[0]).detachFrom(K(h.uuids[1]), d);
                                    ...
                                    var i = Y(e.getDOMElement(h.source)),
                                        j = Y(e.getDOMElement(h.target));
                                    R(i,
                                        function(a) { (a.sourceId == i && a.targetId == j || a.targetId == i && a.sourceId == j) && e.checkCondition("beforeDetach", a) && a.endpoints[0].detach(a, !1, !0, d)
                                        })
                                }
                            }
                        }
                    ...
                    this.deleteObject = function(a) {
                        ...
                        for (var h in b.connections) {
                            ...
                            i._jsPlumb && (jsPlumbUtil.removeWithFunction(p,
                                function(a) {
                                    return i.id == a.id
                    ...
                    this.draggable = function(a, b) {
                        var c, d, f;
                        if ("object" == typeof a && a.length) for (c = 0, d = a.length; d > c; c++) f = e.getDOMElement(a[c]),
                        f && L(f, !0, b);
                        else if (a._nodes) for (c = 0, d = a._nodes.length; d > c; c++) f = e.getDOMElement(a._nodes[c]),
                        f && L(f, !0, b);
                        else f = e.getDOMElement(a),
                            f && L(f, !0, b);
                        return e
                    };
                    ...
                    fb = function(a, b) {
                        ...
                        if (a) if ("string" == typeof a) {
                            ...
                            c.push(a)
                                                    ...
                                                    e = a.length; e > d; d++) c.push(k(a[d]).id);
                        else c.push(k(a).id);
                        return c
                    },
                    gb = function(a, b, c) {
                ...
                var hb = function(a, b) {
                    ...
                    lb = function(a) {
                        ...
                        return t.extend(b, {
                            ...
                            remove: function() {
                                for (var b = 0,
                                         c = a.length; c > b; b++) e.deleteObject({
                                    endpoint: a[b]
                                })
                            }
                        })
                ...
                this.select = function(a) {
                    return a = a || {},
                        a.scope = a.scope || "*",
                        kb(a.connections || e.getConnections(a, !0))
                },
                    this.selectEndpoints = function(a) {
                        ...
                        for (var h in q) {
                            ...
                            if (i || j || l) a: for (var n = 0,
                                ...
                                var p = q[h][n];
                                if (gb(f, p.scope, !0)) {
                                    var r = k && d.length > 0 && !p.isSource,
                                        s = m && e.length > 0 && !p.isTarget;
                                    if (r || s) continue a;
                                    g.push(p)
                                }
                            }
                ...
                this.isSVGAvailable = nb("svg"),
                    this.isVMLAvailable = nb("vml"),
                ...
                this.init = function() {
                    ...
                    o || (rb(), e.anchorManager = new t.AnchorManager({
                        jsPlumbInstance: e
                    }), e.setRenderMode(e.Defaults.RenderMode), o = !0, e.fire("ready", e))
                }.bind(this),
                    this.log = n,
                ...
                var sb = function(a, b, c) {
                    a.paintStyle = a.paintStyle || c.Defaults.EndpointStyles[b] || c.Defaults.EndpointStyle,
                        a.hoverPaintStyle = a.hoverPaintStyle || c.Defaults.EndpointHoverStyles[b] || c.Defaults.EndpointHoverStyle,
                        a.anchor = a.anchor || c.Defaults.Anchors[b] || c.Defaults.Anchor,
                        a.endpoint = a.endpoint || c.Defaults.Endpoints[b] || c.Defaults.Endpoint
                };
                ...
                this.makeTarget = function(c, d, f) {
                    ...
                    t.extend(g, d),
                        sb(g, 1, this);
                    var h = g.scope || e.Defaults.Scope,
                        i = !(g.deleteEndpointsOnDetach === !1),
                        l = g.maxConnections || -1,
                        ...
                        n = function(c) {
                            ...
                            var o = function() {
                                    ...
                                    var a = this.getDropEvent(arguments),
                                        c = this.select({
                                            target: e
                                        }).length,
                                        h = this.getDOMElement(this.getDragObject(arguments)),
                                        j = this.getAttribute(h, "dragId"),
                                        k = this.getAttribute(h, "originalScope"),
                                        l = w[j],
                                        n = l.endpoints[0].isFloating() ? 0 : 1,
                                        o = l.endpoints[0],
                                        p = (g.endpoint ? t.extend({},
                                            g.endpoint) : {},
                                            this.targetEndpointDefinitions[e]);
                                    ...
                                    if (l.suspendedEndpoint) {
                                        l[n ? "targetId": "sourceId"] = l.suspendedEndpoint.elementId,
                                            l[n ? "target": "source"] = l.suspendedEndpoint.element,
                                            l.endpoints[n] = l.suspendedEndpoint;
                                    ...
                                    if (q) {
                                        var s = this.getElementObject(d.el),
                                            u = p.endpoint;
                                        if ((null == u || null == u._jsPlumb) && (u = this.addEndpoint(s, g)), g.uniqueEndpoint && (p.endpoint = u), u._doNotDeleteOnDetach = !1, u._deleteOnDetach = !0, null != u.anchor.positionFinder) {
                                            var v = this.getUIPosition(arguments, this.getZoom()),
                                                x = b(s, this),
                                                y = this.getSize(s),
                                        ...
                                        l[n ? "target": "source"] = u.element,
                                            l[n ? "targetId": "sourceId"] = u.elementId,
                                            l.endpoints[n].detachFromConnection(l),
                                        l.endpoints[n]._deleteOnDetach && (l.endpoints[n].deleteAfterDragStop = !0),
                                            u.addConnection(l),
                                            l.endpoints[n] = u,
                                            l.deleteEndpointsOnDetach = i,
                                            1 == n ? this.anchorManager.updateOtherEndpoint(l.sourceId, l.suspendedElementId, l.targetId, l) : this.anchorManager.sourceChanged(l.suspendedEndpoint.elementId, l.sourceId, l),
                                            O(l, null, a),
                                            l.pending = !1
                            ...
                            n.scope = n.scope || h,
                                n[p] = a.wrap(n[p], o),
                                this.initDroppable(this.getElementObject(d.el), n, !0)
                        }.bind(this);
                    c = H(c);
                    ...
                    this.unmakeTarget = function(a, b) {
                        var c = k(a);
                        return t.destroyDroppable(c.el),
                    ...
                    this.makeSource = function(c, d, f) {
                        ...
                        t.extend(g, d),
                            sb(g, 0, this);
                        var h = g.maxConnections || -1,
                            j = g.onMaxConnections,
                            l = function(c) {
                                var d = c.id,
                                    f = this.getElementObject(c.el),
                                    k = this.getDOMElement(f),
                                    l = function() {
                                    ...
                                    q[o] = a.wrap(q[o],
                                        function() {
                                            if (s && s.apply(this, arguments), this.currentlyDragging = !1, null != u._jsPlumb) {
                                                ...
                                                u.repaint(),
                                                    this.repaint(u.elementId),
                                                    this.repaint(e.targetId)
                                            }
                                        }.bind(this));
                                var w = function(a) {
                                    var b = this.getOriginalEvent(a),
                                        c = this.sourceEndpointDefinitions[n];
                                    if (d = this.getId(this.getDOMElement(f)), c.enabled) {
                                        ...
                                        if (c.maxConnections >= 0 && o >= c.maxConnections) return j && j({
                                            ...
                                            a),
                                            !1;
                                        var p = jsPlumbAdapter.getPositionOnElement(b, k, i),
                                            r = p;
                                        g.parent && (r = jsPlumbAdapter.getPositionOnElement(b, l(), i));
                                        var s = {};
                                        t.extend(s, g),
                                            s.isSource = !0,
                                            s.anchor = [p[0], p[1], 0, 0],
                                            s.parentAnchor = [r[0], r[1], 0, 0],
                                            s.dragOptions = q,
                                            u = this.addEndpoint(d, s),
                                            v = !0,
                                            u.endpointWillMoveTo = g.parent ? l() : null,
                                            u._doNotDeleteOnDetach = !1,
                                            u._deleteOnDetach = !0;
                                        var w = function() {
                                            v && (v = !1, e.deleteEndpoint(u))
                                        };
                                        e.registerListener(u.canvas, "mouseup", w),
                                            e.registerListener(f, "mouseup", w),
                                            e.trigger(u.canvas, "mousedown", a),
                                            jsPlumbUtil.consume(a)
                                    }
                                }.bind(this);
                                this.registerListener(f, "mousedown", w),
                                    this.sourceEndpointDefinitions[n].trigger = w,
                                g.filter && jsPlumbUtil.isString(g.filter) && e.setDragFilter(f, g.filter)
                            }.bind(this);
                        c = H(c);
                    ...
                    this.unmakeSource = function(a, b) {
                        ...
                        return d && e.unregisterListener(c.el, "mousedown", d),
                        b || delete this.sourceEndpointDefinitions[c.id],
                            this
                    },
                ...
                var ub = function(b, c, d, e) {
                        ...
                        if (c = H(c), a.isString(c)) f[c].enabled = e ? !f[c].enabled: d;
                    ...
                    vb = function(b, c) {
                        return b = H(b),
                            a.isString(b) || !b.length ? c.apply(this, [b]) : b.length ? c.apply(this, [b[0]]) : void 0
                    }.bind(this);
                this.toggleSourceEnabled = function(a) {
                    return ub("source", a, null, !0),
                        this.isSourceEnabled(a)
                },
                    ...
                    this.toggleTargetEnabled = function(a) {
                        return ub("target", a, null, !0),
                            this.isTargetEnabled(a)
                    },
                    ...
                    this.remove = function(a, b) {
                        ...
                        return e.doWhileSuspended(function() {
                                e.removeAllEndpoints(c.id, !0),
                                    e.dragManager.elementRemoved(c.id),
                                    delete w[c.id],
                                    e.anchorManager.clearFor(c.id),
                                    e.anchorManager.removeFloatingConnection(c.id)
                            },
                            b === !1),
                        c.el && e.removeElement(c.el),
                            e
                    };
                var wb = {},
                    xb = function() {
                        for (var a in wb) for (var b = 0,
                                                   c = wb[a].length; c > b; b++) {
                            var d = wb[a][b];
                ...
                this.registerListener = function(a, b, c) {
                    ...
                    this.unregisterListener = function(a, b, c) {
                        e.off(a, b, c),
                            jsPlumbUtil.removeWithFunction(wb,
                                function(a) {
                    ...
                    this.reset = function() {
                        e.deleteEveryEndpoint(),
                            ...
                            xb(),
                            e.anchorManager.reset(),
                        jsPlumbAdapter.headless || e.dragManager.reset()
                    },
                    ...
                    this.setId = function(a, b, c) {
                        ...
                        var e = this.getConnections({
                            ...
                            f = this.getConnections({
                                ...
                                !0);
                        b = "" + b,
                            c ? a = this.getDOMElement(b) : (a = this.getDOMElement(d), this.setAttribute(a, "id", b)),
                            q[b] = q[d] || [];
                        for (var g = 0,
                                 h = q[b].length; h > g; g++) q[b][g].setElementId(b),
                            q[b][g].setReferenceElement(a);
                        delete q[d],
                            this.anchorManager.changeId(d, b),
                        this.dragManager && this.dragManager.changeId(d, b);
                    ...
                    this.toggleDraggable = U,
                    this.addListener = this.bind,
                jsPlumbAdapter.headless || (e.dragManager = jsPlumbAdapter.getDragManager(e), e.recalculateOffsets = e.dragManager.updateOffsets)
            };
        jsPlumbUtil.extend(s, jsPlumbUtil.EventGenerator, {
                ...
                registerConnectionType: function(a, b) {
                    this._connectionTypes[a] = t.extend({},
                        b)
                },
                registerConnectionTypes: function(a) {
                    for (var b in a) this._connectionTypes[b] = t.extend({},
                        a[b])
                },
                registerEndpointType: function(a, b) {
                    this._endpointTypes[a] = t.extend({},
                        b)
                },
                registerEndpointTypes: function(a) {
                    for (var b in a) this._endpointTypes[b] = t.extend({},
                        a[b])
                },
                ...
                setParent: function(a, b) {
                    var c = this.getElementObject(a),
                        d = this.getDOMElement(c),
                        e = this.getId(d),
                        f = this.getElementObject(b),
                        g = this.getDOMElement(f),
                        h = this.getId(g);
                    d.parentNode.removeChild(d),
                        g.appendChild(d),
                        this.dragManager.setParent(c, e, f, h)
                },
                getSize: function(a) {
            ...
            jsPlumbAdapter);
        var t = new s;
        "undefined" != typeof window && (window.jsPlumb = t),
    ...
    function() {
        ...
        jsPlumb.Endpoint = function(g) {
            var h = g._jsPlumb,
                i = (jsPlumbAdapter.getAttribute, jsPlumb.getElementObject),
                j = jsPlumbUtil,
                k = g.newConnection,
                l = g.newEndpoint,
                m = g.finaliseConnection,
                n = (g.fireDetachEvent, g.fireMoveEvent),
                o = g.floatingConnections;
            ...
            var q = function() {
                jsPlumbAdapter.removeClass(this.element, h.endpointAnchorClassPrefix + "_" + this._jsPlumb.currentAnchorClass),
            ...
            g._transient || this._jsPlumb.instance.anchorManager.add(this, this.elementId),
                this.setEndpoint = function(a) {
                    ...
                    j.isString(a) ? this.endpoint = b(a, c) : j.isArray(a) ? (c = j.merge(a[1], c), this.endpoint = b(a[0], c)) : this.endpoint = a.clone(),
                        jsPlumb.extend({},
                            c),
                        ...
                        this.bindListeners(this.endpoint, this, s)
                },
                this.setEndpoint(g.endpoint || h.Defaults.Endpoint || jsPlumb.Defaults.Endpoint || "Dot"),
                this.setPaintStyle(g.paintStyle || g.style || h.Defaults.EndpointStyle || jsPlumb.Defaults.EndpointStyle, !0),
                this.setHoverPaintStyle(g.hoverPaintStyle || h.Defaults.EndpointHoverStyle || jsPlumb.Defaults.EndpointHoverStyle, !0),
            ...
            (g.connectionsDetachable === !1 || g.detachable === !1) && (this.connectionsDetachable = !1),
                this.dragAllowedWhenFull = g.dragAllowedWhenFull || !0,
            g.onMaxConnections && this.bind("maxConnections", g.onMaxConnections),
                ...
                this.setElement = function(a) {
                    var b = this._jsPlumb.instance.getId(a),
                        c = this.elementId;
                    return j.removeWithFunction(g.endpointsByElement[this.elementId],
                        function(a) {
                            return a.id == this.id
                        }.bind(this)),
                        ...
                        j.addToList(g.endpointsByElement, b, this),
                        this
                },
                ...
                if (!t && jsPlumb.isDragSupported(this.element)) {
                    var d = {
                        ...
                        q = function() {
                            ...
                            var a = !0;
                            if (this.isEnabled() || (a = !1), null != e || this.isSource || (a = !1), this.isSource && this.isFull() && !this.dragAllowedWhenFull && (a = !1), null == e || e.isDetachable() || (a = !1), a === !1) return h.stopDrag && h.stopDrag(this.canvas),
                                n.stopDrag(),
                                !1;
                            for (var q = 0; q < this.connections.length; q++) this.connections[q].setHover(!1);
                            this.addClass("endpointDrag"),
                                h.setConnectionBeingDragged(!0),
                            e && !this.isFull() && this.isSource && (e = null),
                                h.updateOffset({
                                    elId: this.elementId
                                }),
                                p = this.makeInPlaceCopy(),
                                p.referenceEndpoint = this,
                                p.paint(),
                                b(d, h);
                            var r = i(p.canvas),
                                s = jsPlumbAdapter.getOffset(r, this._jsPlumb.instance),
                                t = i(this.canvas);
                            if (jsPlumbAdapter.setPosition(d.element, s), this.parentAnchor && (this.anchor = h.makeAnchor(this.parentAnchor, this.elementId, h)), h.setAttribute(this.canvas, "dragId", d.id), h.setAttribute(this.canvas, "elId", this.elementId), this._jsPlumb.floatingEndpoint = c(this.getPaintStyle(), this.anchor, this.endpoint, this.canvas, d.element, h, l), this.canvas.style.visibility = "hidden", null == e) this.anchor.locked = !0,
                                this.setHover(!1, !1),
                                e = k({
                                    sourceEndpoint: this,
                                ...
                                h.setDragScope(t, w),
                                    h.fire("connectionDrag", e),
                                    0 === u ? (m = [e.source, e.sourceId, t, v], e.source = d.element, e.sourceId = d.id) : (m = [e.target, e.targetId, t, v], e.target = d.element, e.targetId = d.id),
                                    e.endpoints[0 === u ? 1 : 0].anchor.locked = !0,
                                    e.suspendedEndpoint = e.endpoints[u],
                                    e.suspendedElement = e.endpoints[u].getElement(),
                                    e.suspendedElementId = e.endpoints[u].elementId,
                                    e.suspendedElementType = 0 === u ? "source": "target",
                                    e.suspendedEndpoint.setHover(!1),
                                    this._jsPlumb.floatingEndpoint.referenceEndpoint = e.suspendedEndpoint,
                                    e.endpoints[u] = this._jsPlumb.floatingEndpoint,
                                    e.addClass(h.draggingClass),
                                    this._jsPlumb.floatingEndpoint.addClass(h.draggingClass)
                            }
                            o[d.id] = e,
                                h.anchorManager.addFloatingConnection(d.id, e),
                                j.addToList(g.endpointsByElement, d.id, this._jsPlumb.floatingEndpoint),
                                h.currentlyDragging = !0
                        }.bind(this),
                        r = g.dragOptions || {},
                        s = {},
                        u = jsPlumb.dragEvents.start,
                        v = jsPlumb.dragEvents.stop,
                        w = jsPlumb.dragEvents.drag;
                    r = jsPlumb.extend(s, r),
                        r.scope = r.scope || this.scope,
                        r[u] = j.wrap(r[u], q, !1),
                        r[w] = j.wrap(r[w], n.drag),
                        r[v] = j.wrap(r[v],
                            function() {
                                if (h.setConnectionBeingDragged(!1), e && null != e.endpoints) {
                                    ...
                                    e.endpoints[0 === b ? 1 : 0].anchor.locked = !1,
                                        e.removeClass(h.draggingClass),
                                    e.endpoints[b] == this._jsPlumb.floatingEndpoint && f && e.suspendedEndpoint && (0 === b ? (e.source = m[0], e.sourceId = m[1]) : (e.target = m[0], e.targetId = m[1]), h.setDragScope(m[2], m[3]), e.endpoints[b] = e.suspendedEndpoint, e.isReattach() || e._forceReattach || e._forceDetach || !e.endpoints[0 === b ? 1 : 0].detach(e, !1, !1, !0, a) ? (e.setHover(!1), e.floatingAnchorIndex = null, e._forceDetach = null, e._forceReattach = null, this._jsPlumb.floatingEndpoint.detachFromConnection(e), e.suspendedEndpoint.addConnection(e), h.repaint(m[1])) : e.suspendedEndpoint.detachFromConnection(e)),
                                        h.remove(d.element, !1),
                                        h.deleteObject({
                                            endpoint: p
                                        }),
                                        ...
                                        h.fire("connectionDragStop", e, a),
                                        h.currentlyDragging = !1,
                                        e = null
                                }
                            }.bind(this));
                    var x = i(this.canvas);
                    h.initDraggable(x, r, !0),
                        t = !0
                }
            },
                ...
                if ((this.isTarget || b) && jsPlumb.isDropSupported(this.element)) {
                    ...
                    var f = jsPlumb.dragEvents.drop,
                        ...
                        l = function() {
                            ...
                            var a = h.getDropEvent(arguments),
                                b = h.getDOMElement(h.getDragObject(arguments)),
                                ...
                                if (this.isFull() && this.fire("maxConnections", {
                                    ...
                                    var l = function() {
                                        ...
                                        p = function() {
                                            ...
                                            1 == i ? h.anchorManager.updateOtherEndpoint(f.sourceId, f.suspendedElementId, f.targetId, f) : h.anchorManager.sourceChanged(f.suspendedEndpoint.elementId, f.sourceId, f),
                                                m(f, null, a),
                                                l()
                                        }.bind(this),
                                        q = function() {
                                    ...
                                    k = k && this.isDropAllowed(f.sourceId, f.targetId, f.scope, f, this),
                                        k ? p() : q()
                                }
                                h.currentlyDragging = !1
                            }
                    ...
                    e[f] = j.wrap(e[f], l),
                        e[i] = j.wrap(e[i],
                            function() {
                                var a = jsPlumb.getDragObject(arguments),
                                    b = h.getAttribute(jsPlumb.getDOMElement(a), "dragId"),
                                    c = o[b];
                                if (null != c) {
                        ...
                        h.initDroppable(a, e, !0, c)
                }
            }.bind(this);
            return this.anchor.isFloating || u(i(this.canvas), !0, !(g._transient || this.anchor.isFloating), this),
            ...
            jsPlumbUtil.extend(jsPlumb.Endpoint, OverlayCapableJsPlumbUIComponent, {
                ...
                applyType: function(a) {
                    ...
                    a.scope && (this.scope = a.scope),
                        jsPlumb.extend(this, a, d),
                    a.anchor && (this.anchor = this._jsPlumb.instance.makeAnchor(a.anchor))
                },
                isEnabled: function() {
                ...
                cleanup: function() {
                    ...
                    this._jsPlumb.instance.destroyDraggable(a),
                        this._jsPlumb.instance.destroyDroppable(a)
                },
                setHover: function(a) {
    ...
    function() {
        ...
        jsPlumb.Connection = function(a) {
            var b = (a.newConnection, a.newEndpoint),
                c = (jsPlumb.getElementObject, jsPlumbUtil);
            this.connector = null,
            ...
            this.scope || (this.scope = this.endpoints[0].scope),
                ...
                this.setConnector(this.endpoints[0].connector || this.endpoints[1].connector || a.connector || d.Defaults.Connector || jsPlumb.Defaults.Connector, !0),
            ...
            if (d.updateOffset({
                ...
                var h = d.getCachedData(this.sourceId),
                    i = h.o,
                    j = h.s,
                    k = d.getCachedData(this.targetId),
                    l = k.o,
                    m = k.s,
                    n = g || d.timestamp(),
                    o = this.endpoints[0].anchor.compute({
                        xy: [i.left, i.top],
                        wh: j,
            ...
            jsPlumb.extend(p, this.endpoints[0].getParameters()),
                jsPlumb.extend(p, this.getParameters()),
    ...
    function() {
        jsPlumb.AnchorManager = function(a) {
                        ...
                        for (var r = k.updateOffset({
                            ...
                            if (z || A) {
                                ...
                                var E = k.getCachedData(y),
                                    F = k.getCachedData(x);
                                y == x && (z || A) ? u(j[x], -Math.PI / 2, 0, w, !1, y, 0, !1, "top", x, o, p) : (C || (C = m(x, y, F.o, E.o, w.endpoints[0].anchor, w.endpoints[1].anchor), t[B] = C), z && u(j[x], C.theta, 0, w, !1, y, 0, !1, C.a[0], x, o, p), A && u(j[y], C.theta2, -1, w, !0, x, 1, !0, C.a[1], y, o, p)),
                        ...
                        for (v = 0; v < n.length; v++) {
                            ...
                            if (H.anchor.constructor == jsPlumb.DynamicAnchor) {
                                H.paint({
                                    ...
                                    jsPlumbUtil.addWithFunction(o, n[v][0],
                                        function(a) {
                                            return a.id == n[v][0].id
                                        });
                                for (var I = 0; I < H.connections.length; I++) H.connections[I] !== n[v][0] && jsPlumbUtil.addWithFunction(o, H.connections[I],
                                    function(a) {
                                        return a.id == H.connections[I].id
                                    })
                            } else H.anchor.constructor == jsPlumb.Anchor && jsPlumbUtil.addWithFunction(o, n[v][0],
                                function(a) {
                                    return a.id == n[v][0].id
                                })
                        }
            ...
            k.continuousAnchorFactory = {
                get: function(a) {
                    var b = c[a.elementId];
                    return b || (b = new v(a), c[a.elementId] = b),
                        b
                },
                clear: function(a) {
                    delete c[a]
                ...
                this.x = a.x || 0,
                    ...
                    this.compute = function(a) {
                        ...
                        return a.clearUserDefinedLocation && (this.userDefinedLocation = null),
                            d && d === self.timestamp ? this.lastReturnValue: (this.lastReturnValue = null != this.userDefinedLocation ? this.userDefinedLocation: [b[0] + this.x * c[0] + this.offsets[0], b[1] + this.y * c[1] + this.offsets[1]], this.timestamp = d, this.lastReturnValue)
                    },
                    this.getCurrentLocation = function(a) {
    ...
    function() {
            ...
            jsPlumb.Segments = {
                ...
                Straight: function(a) {
                    ...
                    this.findClosestPointOnPath = function(a, i) {
                        ...
                        if (0 === c) l.y = g,
                            l.x = j(e, f, a) ? a: k(e, f, a);
                        else if (1 / 0 == c || c == -1 / 0) l.x = e,
                            l.y = j(g, h, i) ? i: k(g, h, i);
                        else {
                            var m = g - c * e,
                                n = i - d * a,
                                o = (n - m) / (c - d),
                                p = c * o + m;
                            l.x = j(e, f, o) ? o: k(e, f, o),
                                l.y = j(g, h, p) ? p: k(g, h, p)
                        }
                        var q = Biltong.lineLength([l.x, l.y], [e, g]);
                        return l.d = Biltong.lineLength([a, i], [l.x, l.y]),
                            l.l = q / b,
                            l
                    }
                },
                ...
                this.computeMaxSize = function() {
                    ...
                    this.draw = function(a, d) {
                        ...
                        if (a.pointAlongPathFrom) {
                            ...
                            } else h = a.pointAlongPathFrom(this.loc, e * this.length / 2),
                    ...
                    this.draw = function(a, b, c) {
                        ...
                        if (null != d && 2 == d.length) {
                            ...
                            if (c) f = {
                                ...
                                var g = this.loc,
                                    h = !1; (jsPlumbUtil.isString(this.loc) || this.loc < 0 || this.loc > 1) && (g = parseInt(this.loc, 10), h = !0),
                                    f = a.pointOnPath(g, h)
                            } else {
        ...
        jsPlumbUtil.extend(f, [jsPlumb.DOMElementComponent, d], {
            ...
            jsPlumbUtil.extend(jsPlumb.Overlays.Label, jsPlumb.Overlays.Custom, {
                ...
                getDimensions: function() {
                    return this.update(),
                        f.prototype.getDimensions.apply(this, arguments)
                },
                update: function() {
    ...
    function() {
        ...
        var w = function(a) {
            ...
            this.svg = q("svg", e),
                a.useDivWrapper ? (this.canvas = document.createElement("div"), this.canvas.style.position = "absolute", jsPlumbUtil.sizeElement(this.canvas, 0, 0, 1, 1), this.canvas.className = d) : (p(this.svg, {
                    "class": d
                ...
                this.paint = function(b, d, e) {
                    if (null != b) {
                        ...
                        null != e && (e.xmin < 0 && (g[0] += e.xmin), e.ymin < 0 && (g[1] += e.ymin), h[0] = e.xmax + (e.xmin < 0 ? -e.xmin: 0), h[1] = e.ymax + (e.ymin < 0 ? -e.ymin: 0)),
                            a.useDivWrapper ? (jsPlumbUtil.sizeElement(this.canvas, g[0], g[1], h[0], h[1]), g[0] = 0, g[1] = 0, f = r([0, 0])) : f = r([g[0], g[1]]),
            ...
            jsPlumb.ConnectorRenderers.svg = function(a) {
                ...
                c.renderer.paint = function(c, d, e) {
                    ...
                    if (e.xmin < 0 && (h[0] = -e.xmin), e.ymin < 0 && (h[1] = -e.ymin), f.length > 0) {
                        ...
                        if (c.outlineColor) {
                            var n = c.outlineWidth || 1,
                                o = c.lineWidth + 2 * n;
                            k = jsPlumb.extend({},
                                c),
                                k.strokeStyle = jsPlumbUtil.convertStyle(c.outlineColor),
                                k.lineWidth = o,
                                null == b.bgPath ? (b.bgPath = q("path", j), v(b.svg, b.bgPath, 0), b.attachListeners(b.bgPath, b, m)) : p(b.bgPath, j),
                                u(b.svg, b.bgPath, k, l, b)
                        }
                        null == b.path ? (b.path = q("path", j), v(b.svg, b.path, c.outlineColor ? 1 : 0), b.attachListeners(b.path, b, m)) : p(b.path, j),
                ...
                this.paint = function(a, d) {
                    if (a.component.svg && d) {
                        null == this.path && (this.path = q("path", {
                            "pointer-events": "all"
                        }), a.component.svg.appendChild(this.path), this.canvas = a.component.svg, this.attachListeners(this.path, a.component), this.attachListeners(this.path, this));
            ...
            jsPlumb.Overlays.svg.GuideLines = function() {
                ...
                jsPlumb.Overlays.GuideLines.apply(this, arguments),
                    this.paint = function(f, g) {
                        null == c && (c = q("path"), f.connector.svg.appendChild(c),
                            d.attachListeners(c, f.connector), d.attachListeners(c, d),
                            a = q("path"), f.connector.svg.appendChild(a),
                            d.attachListeners(a, f.connector), d.attachListeners(a, d),
                            b = q("path"), f.connector.svg.appendChild(b),
            ...
            this.paint = function(a, e) {
                if (a.component.canvas && e) {
                    var j = {},
                        k = a.d,
                        l = a.component;
                    a.strokeStyle && (j.stroked = "true", j.strokecolor = jsPlumbUtil.convertStyle(a.strokeStyle, !0)),
                    a.lineWidth && (j.strokeweight = a.lineWidth + "px"),
                    a.fillStyle && (j.filled = "true", j.fillcolor = a.fillStyle);
        ...
        a.extend(jsPlumbInstance.prototype, {
            ...
            getUIPosition: function(a, b, c) {
                ...
                if (b = b || 1, 1 == a.length) d = {
                    ...
                    var e = a[1],
                        f = e.position;
                    d = f || e.absolutePosition,
                    c || (e.position.left /= b, e.position.top /= b)
                }
                return {
                    left: d.left,
                    top: d.top
            ...
            on: function(a) {
                ...
                c.push.apply(c, arguments),
                    a.on.apply(a, c.slice(1))
            },
            off: function(a) {
                a = b(a);
                var c = [];
                c.push.apply(c, arguments),
                    a.off.apply(a, c.slice(1))
            }
        }),
