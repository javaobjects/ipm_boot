...
/**
 * @ClassName: PublicProtoPlanDao
 * @Description: PublicProtoPlan DAO
 * @author chensq
 *
 */
@Repository
public interface PublicProtoPlanDao {
