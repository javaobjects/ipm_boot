!
                ...
                this.paintAlarmText = function(a) {
                    if (null != this.alarm && "" != this.alarm) {
                        var b = this.alarmColor || "255,0,0",
                            c = this.alarmAlpha || .5;
                        a.beginPath(),
                            a.font = this.alarmFont || "10px 寰蒋闆呴粦";
            ...
            this.initialize(),
                ...
                this.paint = function(a) {
                    a.beginPath(),
                        ...
                        this.height = a.measureText("鐢�").width,
                        a.strokeStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")",
                        a.fillStyle = "rgba(" + this.fontColor + ", " + this.alpha + ")",
    ...
    function(a) {
        ...
        function p(a, b) {//err Maximum call stack size exceeded
            if (a.layout) {
                var c = a.layout,
                    d = c.type,
                    e = null;
        ...
        function r(a, b, c) {
            ...
            if (p(b, d), 1 == c) for (var e = 0; e < d.length; e++) r(a, d[e], c);//err Maximum call stack size exceeded
            return null
        }
        function s(b, c) {
            function d(a, b) {
